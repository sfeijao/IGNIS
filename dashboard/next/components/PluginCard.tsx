...
type Props = { name: string; desc: string; badge?: string; icon?: IconName; tip?: string }

export default function PluginCard({ name, desc, badge = 'Beta', icon = 'plugins', tip }: Props) {
  return (
