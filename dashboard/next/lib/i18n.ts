...
const STRINGS: Record<Lang, Record<string, string>> = {
  ...
  'settings.bot.banner.limit': 'Limite ~2.5MB. Vamos redimensionar para caber em 1600×400.',
  ...
  'settings.bot.icon.limit': 'Limite ~2.5MB. Redimensionamos até 256×256 (GIF não é comprimido).',
