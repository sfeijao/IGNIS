...
const STRINGS: Record<Lang, Record<string, string>> = {
  ...
  'settings.bot.banner.hint': 'Opcional. Apenas usado neste servidor (apenas visual e para mensagens futuras). Recomenda-se 1600×400.',
  'settings.bot.banner.previewAlt': 'Pré-visualização do banner',
  'settings.bot.banner.upload': 'Carregar imagem',
  'settings.bot.banner.uploading': 'A carregar…',
  ...
  'settings.bot.banner.remove': 'Remover banner',
  'settings.bot.banner.removed': 'Banner removido',
